      ...
      <el-form label-width="140px" class="w-[680px]">
        ...
        <el-form-item v-if="form.hasGlobal" label="全局属性">
          <div v-for="(i, k) in form.global" :key="k" class="plug-row">
            ...
            <span>
              <el-select class="w-32" v-model="i.type" placeholder="type 必填">
        ...
        <el-form-item v-if="form.hasRequest" label="Request">
          <div v-for="(i, k) in form.request" :key="k" class="plug-row">
            ...
            <span>
              <el-select v-model="i.type" class="w-32" placeholder="type 必填">
                <el-option label="string" value="string" />
                <el-option label="int" value="int" />
                <el-option label="float32" value="float32" />
                <el-option label="float64" value="float64" />
        ...
        <el-form-item>
          ...
          <el-icon class="cursor-pointer ml-3" @click="toDoc('')">
            <VideoCameraFilled />
          </el-icon>
        </el-form-item>
      </el-form>
