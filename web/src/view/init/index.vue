  ...
  <div
    ...
    <div class="rounded-md w-full h-full flex items-center justify-center overflow-hidden">
      ...
      <div v-if="!page.showForm" :class="[page.showReadme ? 'slide-out-right' : 'slide-in-fwd-top']">
        <div class=" text-lg">
          <div class="font-sans text-4xl font-bold text-center mb-4 dark:text-white">Alex</div>
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-2">2.请您确认是否已经阅读过<a class="text-blue-600 font-bold" href=""
              target="_blank">官方文档</a> <a class="text-blue-600 font-bold" href="" target="_blank">初始化视频</a></p>
          <p class="text-gray-600 dark:text-gray-300 mb-2">3.请您确认是否了解后续的配置流程</p>
          <p class="text-gray-600 dark:text-gray-300 mb-2">4.如果您使用mysql数据库，请确认数据库引擎为<span
