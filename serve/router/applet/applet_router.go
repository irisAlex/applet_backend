...
func (s *SupplierRouter) InitSupplierRouter(Router *gin.RouterGroup) {
	...
	supplierRouterApi := v1.ApiGroupApp.AppletApiGroup.SupplierApi
	{
...
func (s *TypeRouter) InitTypeRouter(Router *gin.RouterGroup) {
	...
	typeRouterApi := v1.ApiGroupApp.AppletApiGroup.TypeApi
	{
...
func (s *TypeRouter) InitProjectRouter(Router *gin.RouterGroup) {
	...
	typeRouterApi := v1.ApiGroupApp.AppletApiGroup.ProjectApi
	{
...
func (s *ManageRouter) InitManageRouter(Router *gin.RouterGroup) {
	...
	typeRouterApi := v1.ApiGroupApp.AppletApiGroup.ManageApi
	{
		...
		typeApiRouter.POST("updateApplet", typeRouterApi.SetApplet)      // 更新放行时间
...
func (s *ComplaintRouter) InitComplaintRouter(Router *gin.RouterGroup) {
	...
	typeRouterApi := v1.ApiGroupApp.AppletApiGroup.ComplaintApi
	{
...
func (s *ComplaintRouter) InitMessageRouter(Router *gin.RouterGroup) {
	...
	typeRouterApi := v1.ApiGroupApp.AppletApiGroup.MessageApi
	{
		...
		typeApiRouter.POST("getMessageByAppletID", typeRouterApi.GetMessageMessageByAppletID) // 更新api
	}
	{
...
func (s *ProductRouter) InitProductRouter(Router *gin.RouterGroup) {
	...
	supplierRouterApi := v1.ApiGroupApp.AppletApiGroup.ProductApi
	{
