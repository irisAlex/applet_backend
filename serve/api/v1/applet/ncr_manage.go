...
func (s *ManageApi) GetManageList(c *gin.Context) {
	var pageInfo appleteq.SearchManageParams
...
func (s *ManageApi) GetManageById(c *gin.Context) {
	...
	response.OkWithDetailed(appletep.ManageResponse{Applet: api}, "获取成功", c)
}
...
func (s *ManageApi) SetStatus(c *gin.Context) {
	...
	err = ManageService.SetAppletStatus(uint(api.ID), api.Status)
	if err != nil {
...
func (s *ManageApi) SetPassDate(c *gin.Context) {
	...
	err = ManageService.SetAppletPassDate(uint(api.ID), api.Operation_Type)
	if err != nil {
...
func (s *ManageApi) SetApplet(c *gin.Context) {
	...
	err = ManageService.SetApplet(uint(api.ID))
	if err != nil {
...
func (s *ManageApi) DownExcelFile(c *gin.Context) {
	...
	response.OkWithDetailed(appletep.ManageResponse{Applet: api}, "下载成功", c)
}
