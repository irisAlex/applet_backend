...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "", Name: "", Component: "/", Sort: 0, Meta: Meta{Title: "官方网站", Icon: "customer-gva"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: 24, Path: "", Name: "", Component: "", Sort: 0, Meta: Meta{Title: "插件市场", Icon: "shop"}},
