...
func (apiService *ProductApiService) CreateApi(supplier ncr.Product) (err error) {
	return global.GVA_DB.Create(&supplier).Error
}

func (apiService *ProductApiService) DeleteProduct(supplier ncr.Product) (err error) {
	var entity ncr.Product
...
func (apiService *ProductApiService) GetAPIInfoList(api ncr.Product, info request.PageInfo, order string, desc bool) (list interface{}, total int64, err error) {
	limit := info.PageSize
	offset := info.PageSize * (info.Page - 1)
	db := global.GVA_DB.Model(&ncr.Product{})
	var apiList []ncr.Product
...
func (apiService *ProductApiService) GetProductById(id int) (api ncr.Product, err error) {
...
func (apiService *ProductApiService) UpdateProduct(api ncr.Product) (err error) {
